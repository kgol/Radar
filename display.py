...
def draw(radarDisplay, targets, angle, distance, fontRenderer, screen_width, screen_height):
     # draw initial screen
    ...
    # horizental line
    pygame.draw.line(radarDisplay, colors.green, (0, (round(screen_height))), ((round(screen_width)), (round(screen_height))), 1)

    # 45 degree line
    pygame.draw.line(radarDisplay, colors.green, (0, 0),(205, 285), 1)
    ...
    pygame.draw.line(radarDisplay, colors.green, (round((screen_width/2)), round((screen_height))), (700 - int(b), 780 - int(a)), 3)
